...
export class CrudListColumnBuilder {
  ...
  private _fnClick?: (value: any) => void;
  ...
  public fnClick(val: (value: any) => void): CrudListColumnBuilder {
    this._fnClick = val;
    return this;
  }
